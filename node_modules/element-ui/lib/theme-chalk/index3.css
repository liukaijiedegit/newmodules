...
.el-table tr td {
	border-left: none; 
	border-right: none;
	border-top: 2px #354166 solid;
	border-bottom: 2px #354166 solid;
  }
...
.el-message-box__header {
	...
	background: -webkit-linear-gradient(#283357, #414d74); 
  	background: -o-linear-gradient(#283357, #414d74); 
 	background: -moz-linear-gradient(#283357, #414d74); 
...
.el-tabs--border-card>.el-tabs__header .el-tabs__item.is-active {
	color: #57e29b;
	/*background-color: #fff;*/
	border-top:solid 1px #57e29b;
	border-bottom-color: #57e29b
}
...
.el-button {
	...
	font-size: 14px;
	border-radius: 4px;
	background: -webkit-linear-gradient(#fcfeff, #c9e7f8);
	background: -o-linear-gradient(#fcfeff, #c9e7f8);
	background: -moz-linear-gradient(#fcfeff, #c9e7f8);
	background: linear-gradient(#fcfeff, #c9e7f8);
}
...
.el-button--primary {
	background: -webkit-linear-gradient(left,#31f394, #31e4c1);
	background: -o-linear-gradient(right,#31f394, #31e4c1);
	background: -moz-linear-gradient(right,#31f394, #31e4c1);
